...
class _AnchorTargetLayer(nn.Module):
    ...
    labels and bounding-box regression target.
    '''
    ...
    def forward(self, inpt):
        '''
        For each (H, W) location i, generate 9 anchor boxes centered on cell i
        ...
        max_overlaps, argmax_overlaps = torch.max(overlaps, 2)  #(batch_size, N)
...
#           num_bg = cfg.TRAIN.RPN_BATCHSIZE - sum_fg[i]
        ...
        # gt_boxes --> (batch_size, K, 5), this example K=20
        # (batch_size,)
